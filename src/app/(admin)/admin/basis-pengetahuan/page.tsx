"use client";
// Halaman untuk menampilkan aturan basis pengetahuan.
// Fungsionalitas akan ditambahkan nanti.

export default function BasisPengetahuanPage() {
	// Dummy data untuk jumlah pakar, nanti ini akan dinamis
	const pakarCount = 2;
				...
				<table className='w-full text-sm text-left text-gray-500'>
					<thead className='text-xs text-gray-700 uppercase bg-gray-50'>
						<tr>
							...
							{/* Membuat kolom header CF Pakar secara dinamis */}
							{Array.from({ length: pakarCount }, (_, i) => (
					...
					<tbody>
						...
						<tr className='bg-white border-b'>
							<td className='px-6 py-4 font-medium text-gray-900'>Scabies</td>
							<td className='px-6 py-4'>Bulu rontok</td>
							{/* Kolom value CF Pakar */}
							<td className='px-6 py-4'>0.8</td>
							<td className='px-6 py-4'>0.7</td>
